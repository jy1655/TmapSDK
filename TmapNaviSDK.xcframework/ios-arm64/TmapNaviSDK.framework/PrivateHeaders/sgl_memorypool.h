...
#ifndef __SGL_MEMORY_POOL_H__
#define __SGL_MEMORY_POOL_H__
 ...
 */
class CSglMemoryPool : public IMemoryBlock
{
  public :
    /*!
	Contructor
	...
	*/
    CSglMemoryPool(const std::size_t &sInitialMemoryPoolSize = DEFAULT_MEMORY_POOL_SIZE, 
    ...
    virtual ~CSglMemoryPool() ; //!< Destructor
